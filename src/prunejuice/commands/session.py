...
def list(
    ...
    try:
        ...
        if not pots.is_available():
            console.print("❌ Pots integration not available", style="bold red")
            console.print("Please ensure pots is installed and tmux is available", style="dim")
...
def create(
    ...
    working_dir: Optional[str] = typer.Option(None, "--dir", "-d", help="Worktree directory (default: current)")
):

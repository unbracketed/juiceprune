...
class CommandLoader:
    ...
    def _resolve_base_command(self, base_name: str, current_file: str) -> Optional[Dict[str, Any]]:
    ...
    def _merge_command_data(self, base_data: Dict[str, Any], derived_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for list_key in ['pre_steps', 'steps', 'post_steps', 'cleanup_on_failure', 'arguments']:

...
class FileManager:
    ...
    def copy_files(
        ...
        logger.info(
            f"Copy results: {results['copied_count']} copied, "
    ...
    def copy_files_with_patterns(
        self, target_root: Path, patterns: List[str]
    ) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary with copy results and statistics
        """
        results = {"copied": [], "failed": [], "copied_count": 0, "failed_count": 0}
        ...
        logger.info(
            f"Pattern copy results: {results['copied_count']} copied, "
    ...
    def handle_mcp_templates(
        ...
        try:
            ...
            if source_template_dir.is_dir():
                shutil.copytree(
                    source_template_dir, target_template_dir, dirs_exist_ok=True
                )
